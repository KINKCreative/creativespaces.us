    ...
    $(document).ready(function() {
        ...
        $('#contactform').submit(function() {
            ...
            $("#message").slideUp(750, function() {
                $('#message').hide();
                $('#submit')
                    .after('<img src="assets/img/contact-form-loader.gif" class="loader" />')
        ...
        // Google Map
        function initialize() {
            var myLatlng = new google.maps.LatLng(34.0441709, -118.2536443); // Change your location Latitude and Longitude
            var mapOptions = {
                zoom: 10,
                center: myLatlng
            }
