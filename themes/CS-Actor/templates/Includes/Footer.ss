    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <small>&copy; {$Now.Year} $SiteConfig.Title <% if SiteConfig.Tagline %> | $SiteConfig.Tagline<% end_if %> | Powered by <a href="http://www.creativespaces.us" target="_blank"><strong>creativespaces</strong>.us</a></small>
